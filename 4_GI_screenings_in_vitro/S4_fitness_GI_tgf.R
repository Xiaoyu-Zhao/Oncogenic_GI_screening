...
p
ggsave("tgf/fitness/tgf_SKO_fitness_53_genes.pdf", width = 3.6, height= 9)
...
ggsave("tgf/fitness/Reproducibility_gene_level_fitnesss_tgf.pdf", width =4.4, height = 4)
...
ggsave("tgf/GI/Reproducibility_gene_level_GI_score_tgf.pdf", width = 4.4, height = 4)
...
for (svalue in totalvalues) {
  ...
  #GI profiling 
  png(filename = paste("tgf/GI/", svalue, ".correlation.Based.On.GI.png",sep=""),width=1000, height=1000)
