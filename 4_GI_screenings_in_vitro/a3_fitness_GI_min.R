...
res <- data.frame(read_excel("TableS1_Annotatation_of_asssyed_TSGs_or_TSG_combinations.xlsx", 5))
...
for (svalue in totalvalues) {
  ...
  #GI profiling 
  pdf(file = paste("minimal/GI/", svalue, ".correlation.Based.On.GI.pdf",sep=""),width=15, height=15)
