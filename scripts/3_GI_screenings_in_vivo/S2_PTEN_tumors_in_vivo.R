...
ggi$hL = 0
ggi[which((ggi$oncogenic == "Yes_oncogenic") & (ggi$Max > 0) & (ggi$p.max.adj < 0.05)),"hL"] = 1  #17
...
ggsave("Max_Min_GGi_PTEN_tumors.pdf", width=6.2, height =6.8)
...
sample = factor(df$samples, levels = c("Cell.1", "Cell.2", "F911.3",  "F912.2", "F912.3", "F913.1", "F913.2","F913.4", "F912.1", "F912.4", "F913.3"))
...
#scale_fil8
ggsave("SKO_DKO_NTC_individual_tumors_PTEN.pdf", width = 5.8, height = 5.8)
