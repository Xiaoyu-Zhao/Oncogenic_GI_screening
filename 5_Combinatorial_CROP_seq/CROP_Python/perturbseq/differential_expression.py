...
#def _get_tree_num(n_feat, depth=100):
    if depth == None:
        depth = 10
...
def _test_feature_performance(X, y, clf='extra', n_estimators=None, random_state=None, test_size=0.3, target_names=None, n_jobs=1):
